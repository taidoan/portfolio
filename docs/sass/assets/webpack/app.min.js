...
(self.webpackChunk = self.webpackChunk || []).push([
  [524],
  {
    6799: function (e, n, t) {
      ...
      const l = () => {
          const e = o('body');
          e.on('toggle:close', '[data-toggle="button"]', function () {
            const e = o(this).attr('aria-controls'),
              n = o(`[data-target-id="${e}"]`);
            o(`[data-toggle="button"][aria-controls="${e}"][aria-pressed="true"]`).attr(
              'aria-pressed',
              'false',
            ),
              n.trigger('target:close');
          }),
            e.on('toggle:open', '[data-toggle="button"]', function () {
              const e = o(this),
                n = e.attr('aria-controls'),
                t = o(`[data-target-id="${n}"]`),
                a = o(`[data-toggle="button"][aria-controls="${n}"]`).not(e);
              e.data('toggle-synced')
                ? a.filter('[data-toggle-synced="true"]').attr('aria-pressed', 'true')
                : a.filter('[aria-pressed="true"]').attr('aria-pressed', 'false'),
                e.attr('aria-pressed', 'true'),
                t.trigger('target:open');
            }),
            e.on('target:close', '[data-toggle="target"]', function (e) {
              const n = o(this);
              o(e.target).is(n) && n.attr('aria-expanded', 'false');
            });
          const n = (e) => {
            const n = e.attr('data-target-id'),
              t = o(`[data-toggle="button"][aria-controls="${n}"][aria-pressed="true"]`);
            t.length ? t.trigger('toggle:close') : e.trigger('target:close');
          };
          e.on('target:open', '[data-toggle="target"]', function (e) {
            const n = o(this);
            o(e.target).is(n) && n.attr('aria-expanded', 'true');
          }),
            e.on('click', '[data-toggle="button"]', function (e) {
              e.preventDefault();
              const n = o(this);
              'true' === n.attr('aria-pressed')
                ? n.trigger('toggle:close')
                : n.trigger('toggle:open');
            }),
            e.on('click', '[data-toggle="close"]', function (e) {
              e.preventDefault();
              const t = o(`[data-target-id="${o(this).attr('aria-controls')}"]`);
              n(t);
            }),
            e.on('click', (e) => {
              o('[data-toggle="target"][aria-expanded="true"][data-auto-closing="true"]').each(
                (t, a) => {
                  ((e, t) => {
                    const a = t.attr('data-target-id'),
                      i = e.closest(`[aria-controls="${a}"]`).length,
                      r = document.contains(e.get(0)),
                      s = !e.closest(t).length,
                      o = t.attr('data-auto-closing-exception'),
                      l = !!o && e.closest(o).length;
                    !i && (t.data('auto-closing-on-any-click') || (r && s && !l)) && n(t);
                  })(o(e.target), o(a));
                },
              );
            });
        ...
        c = () => {
          const e = (e) => {
              e.contentWindow.document.body &&
                (e.height = o(e.contentWindow.document).outerHeight(!0));
            },
            n = () => {
          ...
          a.registerLanguage('django', i),
            ...
            (() => {
              const e =
                s() &&
                s().sizes &&
                s().sizes['layout-sizes'] &&
                s().sizes['layout-sizes']['nav-break'];
              if (e) {
                const n = o('#nav'),
                  t = o('[aria-controls="nav"]'),
                  a = window.matchMedia(`(min-width: ${e})`),
                  i = (e) => {
                    e.matches
                      ? n.attr('aria-expanded', 'true')
                      : n.attr('aria-expanded', t.attr('aria-pressed'));
                  };
                i(a), a.addListener(i);
              }
            })();
      ...
      e.exports = {
        colors: {
          'brand-colors': {
            ...
            'brand-pink': 'rgb(169.83, 13.77, 91.8)',
          },
          'neutral-colors': {
            'light-gray': 'rgb(221.85, 221.85, 221.85)',
            gray: 'hsl(195, 5%, 35%)',
            'contrast-light': '#fff',
            'contrast-dark': 'rgb(59.35125, 64.036875, 65.59875)',
          },
          'theme-colors': {
            'theme-dark': 'hsl(195, 85%, 35%)',
            'theme-light': 'rgb(206.6775, 229.43625, 237.0225)',
            background: '#fff',
            text: 'rgb(59.35125, 64.036875, 65.59875)',
            'text-light': 'hsl(195, 5%, 35%)',
            action: 'rgb(184.6678125, 29.77921875, 108.1996875)',
            focus: 'hsl(195, 85%, 35%)',
            underline: 'rgb(237.416953125, 198.6948046875, 218.299921875)',
            border: 'hsl(195, 5%, 35%)',
            'border-light': 'rgb(221.85, 221.85, 221.85)',
            shadow: 'rgba(84.7875, 91.48125, 93.7125, 0.5)',
            callout: 'rgb(206.6775, 229.43625, 237.0225)',
            slight: 'rgb(250.16775, 252.443625, 253.20225)',
            code: 'hsl(195, 85%, 35%)',
            'code-shadow': 'rgba(13.3875, 127.18125, 165.1125, 0.2)',
          },
          'hljs-colors': {
            'hljs-comment': '#93a1a1',
            'hljs-green': '#859900',
          ...
          'demo-colors': { 'brand-blue': 'hsl(195, 85%, 35%)', 'brand-pink': 'hsl(330, 85%, 48%)' },
          'demo-noncolors': {
            'light-gray': 'rgb(221.85, 221.85, 221.85)',
            gray: 'hsl(195, 5%, 35%)',
            'contrast-dark': 'rgb(59.35125, 64.036875, 65.59875)',
        ...
        ratios: { 'text-ratios': { 'line-height': 1.4 }, 'demo-ratios': { 'line-height': 1.4 } },
        sizes: {
          'root-sizes': {
            root: '18px',
          ...
          'demo-sizes-text': { root: '18px', responsive: 'calc(1.5em + 1vw)', xlarge: '3rem' },
          'demo-sizes-theme': {
            icon: '1rem',
            card: '30vw',
            quote: '50%',
          ...
          'demo-sizes-large': { box: '20em', page: '75ch' },
        },
        fonts: {
          sans: {
            name: 'Source Sans 3',
            ...
            clearTimeout(a),
              (a = setTimeout(function () {
                for (var n = 0, t = i.length; n < t; n++) {
                  ...
                  if (s !== a.matches) {
                    a.matches = s;
                    for (var o = 0, l = r.length; o < l; o++) r[o].call(window, a);
                  }
                }
              }, 30));
          };
          ...
          return (
            (s.addListener = function (e) {
              n &&
                ...
                0 === l && (l = i.push({ mql: s, listeners: o })),
                o.push(e));
            }),
            (s.removeListener = function (e) {
              for (var n = 0, t = o.length; n < t; n++) o[n] === e && o.splice(n, 1);
            }),
            s
          );
        };
        ...
        (window.matchMedia = (function () {
          ...
          if (!e) {
            ...
            (t.type = 'text/css'),
              ...
              a ? a.parentNode.insertBefore(t, a) : document.head.appendChild(t),
              (n =
              ...
              (e = {
                matchMedium: function (e) {
                  ...
                  return (
                    t.styleSheet ? (t.styleSheet.cssText = a) : (t.textContent = a),
                    '1px' === n.width
                  );
                },
              });
        ...
        (t = function (e) {
          !(function (e, n) {
            var t,
              a,
              i,
              r = !!('srcdoc' in document.createElement('iframe')),
              s =
                'Polyfill may not function in the presence of the `sandbox` attribute. Consider using the `force` option.',
              o = /\ballow-same-origin\b/,
              l = function (e, n) {
                var t = e.getAttribute('sandbox');
                'string' != typeof t ||
                  o.test(t) ||
                  (n && n.force
                    ? e.removeAttribute('sandbox')
                    : (n && !1 === n.force) || (i(s), e.setAttribute('data-srcdoc-polyfill', s)));
              },
              c = function (e, n, t) {
              ...
              d = function (e, n, t) {
                ...
                e &&
                  e.getAttribute &&
                  (n ? e.setAttribute('srcdoc', n) : (n = e.getAttribute('srcdoc')),
                  n &&
                    (l(e, t),
                    (a = "javascript: window.frameElement.getAttribute('srcdoc');"),
            ...
            if (
              ...
              (g.noConflict = function () {
                return (window.srcDoc = n), g;
              }),
              !r)
            )
              for (g.set = d, t = (a = document.getElementsByTagName('iframe')).length; t--; )
                g.set(a[t]);
          })(e, i),
            (a.srcDoc = e);
        }.apply(n, [n])),
    ...
    7639: function (e, n, t) {
      var a = t(3973);
      a.registerLanguage('xml', t(1869)),
        a.registerLanguage('bash', t(6760)),
        a.registerLanguage('c', t(3089)),
        a.registerLanguage('cpp', t(8049)),
        a.registerLanguage('csharp', t(7025)),
        a.registerLanguage('css', t(3355)),
        a.registerLanguage('markdown', t(687)),
        a.registerLanguage('diff', t(6361)),
        a.registerLanguage('ruby', t(9386)),
        a.registerLanguage('go', t(1468)),
        a.registerLanguage('graphql', t(7753)),
        a.registerLanguage('ini', t(9682)),
        a.registerLanguage('java', t(6418)),
        a.registerLanguage('javascript', t(3113)),
        a.registerLanguage('json', t(20)),
        a.registerLanguage('kotlin', t(4063)),
        a.registerLanguage('less', t(1075)),
        a.registerLanguage('lua', t(7190)),
        a.registerLanguage('makefile', t(374)),
        a.registerLanguage('perl', t(3315)),
        a.registerLanguage('objectivec', t(9318)),
        a.registerLanguage('php', t(7592)),
        a.registerLanguage('php-template', t(1507)),
        a.registerLanguage('plaintext', t(619)),
        a.registerLanguage('python', t(944)),
        a.registerLanguage('python-repl', t(2120)),
        a.registerLanguage('r', t(8210)),
        a.registerLanguage('rust', t(8368)),
        a.registerLanguage('scss', t(4222)),
        a.registerLanguage('shell', t(7846)),
        a.registerLanguage('sql', t(984)),
        a.registerLanguage('swift', t(2723)),
        a.registerLanguage('yaml', t(8005)),
        a.registerLanguage('typescript', t(5745)),
        a.registerLanguage('vbnet', t(775)),
        a.registerLanguage('wasm', t(5930)),
        (a.HighlightJS = a),
        (a.default = a),
        (e.exports = a);
    },
    3973: function (e) {
      function n(e) {
        return (
          ...
          Object.getOwnPropertyNames(e).forEach((t) => {
            const a = e[t],
              i = typeof a;
            ('object' !== i && 'function' !== i) || Object.isFrozen(a) || n(a);
          }),
          e
        );
      }
      ...
      const y = '[a-zA-Z]\\w*',
        ...
        D = { scope: 'number', begin: N, relevance: 0 },
        I = {
          scope: 'regexp',
          begin: /\/(?=[^/\n]*\/)/,
          end: /\/[gimuy]*/,
        ...
        L = { scope: 'title', begin: y, relevance: 0 },
        B = { scope: 'title', begin: w, relevance: 0 },
        z = { begin: '\\.\\s*' + w, relevance: 0 };
      var $ = Object.freeze({
        __proto__: null,
        APOS_STRING_MODE: x,
        BACKSLASH_ESCAPE: k,
      ...
      function ee(e, n, { key: t }) {
        ...
        const i = e[t],
          r = {},
          s = {};
        for (let e = 1; e <= n.length; e++) (s[e + a] = i[e]), (r[e + a] = !0), (a += f(n[e - 1]));
        ...
        !(function (e) {
          ...
          (function (e) {
            if (Array.isArray(e.begin)) {
              ...
              ee(e, e.begin, { key: 'beginScope' }), (e.begin = _(e.begin, { joinWith: '' }));
            }
          })(e),
          (function (e) {
            if (Array.isArray(e.end)) {
              ...
              ee(e, e.end, { key: 'endScope' }), (e.end = _(e.end, { joinWith: '' }));
            }
          })(e);
      }
      function te(e) {
        ...
        le = function (e) {
          ...
          function _(e, n, i, r) {
              ...
              null != O.subLanguage
                ? (function () {
                    ...
                    if ('string' == typeof O.subLanguage) {
                      ...
                      (e = _(O.subLanguage, S, !0, M[O.subLanguage])), (M[O.subLanguage] = e._top);
                    } else e = y(S, O.subLanguage.length ? O.subLanguage : null);
            ...
            function m(e, n) {
              return (
                ...
                e.beginScope &&
                  (e.beginScope._wrap
                    ? (u(S, v.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = ''))
                    : e.beginScope._multi && (b(e.beginScope, n), (S = ''))),
            ...
            function p(e, n, a) {
              ...
              if (e.endsWithParent) return p(e.parent, n, a);
            }
            function f(e) {
            ...
            function h(e) {
              ...
              return i.starts && m(i.starts, e), r.returnEnd ? 0 : t.length;
            }
            let w = {};
            function E(a, r) {
              const o = r && r[0];
            ...
            try {
              ...
              return (
                A.finalize(),
                (x = A.toHTML()),
                { language: e, value: x, relevance: C, illegal: !1, _emitter: A, _top: O }
              );
            } catch (t) {
          ...
          function w(e) {
            ...
            const t = (function (e) {
              ...
              return n.split(/\s+/).find((e) => f(e) || N(e));
            })(e);
            if (f(t)) return;
            if ((O('before:highlightElement', { el: e, language: t }), e.dataset.highlighted))
            ...
            const a = n.textContent,
              r = t ? h(a, { language: t, ignoreIllegals: !0 }) : y(a);
            (e.innerHTML = r.value),
            ...
            Object.assign(e, {
              ...
              registerLanguage: function (n, t) {
                ...
                try {
                  ...
                  if (
                    (X("Language definition for '{}' could not be registered.".replace('{}', n)),
                    !s)
                  )
                    throw e;
                  X(e), (i = l);
                ...
                i.name || (i.name = n),
                  (a[n] = i),
                  (i.rawDefinition = t.bind(null, e)),
                  i.aliases && k(i.aliases, { languageName: n });
              },
    ...
    6760: function (e) {
      e.exports = function (e) {
        ...
        const i = { className: 'subst', begin: /\$\(/, end: /\)/, contains: [e.BACKSLASH_ESCAPE] },
          ...
          o = { className: 'string', begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, t, i] };
        i.contains.push(o);
        const l = {
            begin: /\$?\(\(/,
            end: /\)\)/,
    ...
    6418: function (e) {
      ...
      function r(e, n, t) {
        return -1 === t ? '' : e.replace(n, (a) => r(e, n, t - 1));
      }
      e.exports = function (e) {
        const n = e.regex,
    ...
    3113: function (e) {
      ...
      e.exports = function (e) {
        const c = e.regex,
          ...
          u = { $pattern: n, keyword: t, literal: a, built_in: l, 'variable.language': o },
          b = '[0-9](_?[0-9])*',
          m = `\\.(${b})`,
          ...
          h = { className: 'subst', begin: '\\$\\{', end: '\\}', keywords: u, contains: [] },
          _ = {
            begin: '.?html`',
            end: '',
            starts: {
          ...
          E = { className: 'string', begin: '`', end: '`', contains: [e.BACKSLASH_ESCAPE, h] },
          v = {
            className: 'comment',
            variants: [
              e.COMMENT(/\/\*\*(?!\/)/, '\\*/', {
          ...
          N = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, _, y, w, E, { match: /\$\d+/ }, f];
        h.contains = N.concat({
          begin: /\{/,
          end: /\}/,
          keywords: u,
        ...
        const k = [].concat(v, h.contains),
          x = k.concat([
            { begin: /(\s*)\(/, end: /\)/, keywords: u, contains: ['self'].concat(k) },
          ]),
          O = {
            className: 'params',
            begin: /(\s*)\(/,
        ...
        return {
          ...
          keywords: u,
          exports: { PARAMS_CONTAINS: x, CLASS_REFERENCE: A },
          illegal: /#(?![$_A-z])/,
          contains: [
            ...
            { beginKeywords: 'while if switch catch for' },
            {
              ...
              returnBegin: !0,
              label: 'func.def',
              contains: [O, e.inherit(e.TITLE_MODE, { begin: d, className: 'title.function' })],
            },
            { match: /\.\.\./, relevance: 0 },
            R,
            { match: '\\$' + d, relevance: 0 },
    ...
    1075: function (e) {
      ...
      e.exports = function (e) {
        const o = ((e) => ({
          ...
          f = { begin: '\\(', end: '\\)', contains: u, keywords: p, relevance: 0 };
        u.push(
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
          b("'"),
        ...
        const h = u.concat({ begin: /\{/, end: /\}/, contains: g }),
          _ = {
            beginKeywords: 'when',
            endsWithParent: !0,
            contains: [{ beginKeywords: 'and not' }].concat(u),
          },
          y = {
            begin: d + '\\s*:',
            returnBegin: !0,
          ...
          N = { begin: c + ':(:)?' + `(${l.join('|')})`, returnBegin: !0, contains: [v] };
        return (
          g.push(
            e.C_LINE_COMMENT_MODE,
            e.C_BLOCK_COMMENT_MODE,
    ...
    7592: function (e) {
      e.exports = function (e) {
        const n = e.regex,
          ...
          y = { scope: 'attr', match: n.concat(a, n.lookahead(':'), n.lookahead(/(?!::)/)) },
          w = {
            relevance: 0,
            begin: /\(/,
            end: /\)/,
            keywords: m,
            contains: [y, r, _, e.C_BLOCK_COMMENT_MODE, c, d, f],
          },
          E = {
            relevance: 0,
            match: [
        ...
        w.contains.push(E);
        const v = [y, _, e.C_BLOCK_COMMENT_MODE, c, d, f];
        return {
          case_insensitive: !1,
          keywords: m,
          contains: [
    ...
    2723: function (e) {
      ...
      const r = (e) => a(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
        ...
        d = ['false', 'nil', 'true'],
        g = ['assignment', 'associativity', 'higherThan', 'left', 'lowerThan', 'none', 'right'],
        u = [
          '#colorLiteral',
          '#column',
          '#dsohandle',
      ...
      e.exports = function (e) {
        const n = { match: /\s+/, relevance: 0 },
          m = e.COMMENT('/\\*', '\\*/', { contains: ['self'] }),
          h = [e.C_LINE_COMMENT_MODE, m],
          N = { match: [/\./, i(...s, ...o)], className: { 2: 'keyword' } },
          k = { match: a(/\./, i(...c)), relevance: 0 },
          x = c.filter((e) => 'string' == typeof e).concat(['_|0']),
          O = {
            variants: [
              {
                className: 'keyword',
          ...
          M = { $pattern: i(/\b\w+/, /#\w+/), keyword: x.concat(u), literal: d },
          A = [N, k, O],
          S = [
          ...
          $ = (e = '') => ({ begin: a(e, /"""/), end: a(/"""/, e), contains: [L(e), B(e), z(e)] }),
          F = (e = '') => ({ begin: a(e, /"/), end: a(/"/, e), contains: [L(e), z(e)] }),
          j = {
            className: 'string',
            variants: [$(), $('#'), $('##'), $('###'), F(), F('#'), F('##'), F('###')],
          },
          ...
          q = (e) => {
            ...
            return {
              ...
              contains: [...U, { scope: 'comment', begin: `#(?!.*${t})`, end: /$/ }],
            };
          },
          K = { scope: 'regexp', variants: [q('###'), q('##'), q('#'), P] },
          H = { match: a(/`/, y, /`/) },
          G = [
            H,
            { className: 'variable', match: /\$\d+/ },
            { className: 'variable', match: `\\$${_}+` },
          ],
          Z = [
            {
              match: /(@|#(un)?)available/,
              scope: 'keyword',
              starts: {
                contains: [{ begin: /\(/, end: /\)/, keywords: v, contains: [...T, I, j] }],
              },
            },
            { scope: 'keyword', match: a(/@/, i(...E), t(i(/\(/, /\s+/))) },
            { scope: 'meta', match: a(/@/, y) },
          ],
          W = {
            match: t(/\b[A-Z]/),
            relevance: 0,
            contains: [
              {
                className: 'type',
                match: a(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, _, '+'),
              },
              { className: 'type', match: w, relevance: 0 },
              { match: /[?!]+/, relevance: 0 },
              { match: /\.\.\./, relevance: 0 },
              { match: a(/\s+&\s+/, t(w)), relevance: 0 },
            ],
          },
          Q = { begin: /</, end: />/, keywords: M, contains: [...h, ...A, ...Z, C, W] };
        W.contains.push(Q);
        const X = {
            begin: /\(/,
            end: /\)/,
            ...
            contains: [
              'self',
              { match: a(y, /\s*:/), keywords: '_|0', relevance: 0 },
              ...h,
              K,
              ...A,
              ...S,
          ...
          V = { begin: /</, end: />/, keywords: 'repeat each', contains: [...h, W] },
          J = {
            begin: /\(/,
            end: /\)/,
            keywords: M,
          ...
          Y = {
            match: [/(func|macro)/, /\s+/, i(H.match, y, f)],
            className: { 1: 'keyword', 3: 'title.function' },
            contains: [V, J, n],
            illegal: [/\[/, /%/],
          },
          ...
          ne = { match: [/operator/, /\s+/, f], className: { 1: 'keyword', 3: 'title' } },
          te = {
            begin: [/precedencegroup/, /\s+/, w],
          ...
          ae = {
            ...
            contains: [
              ...
              ...A,
              {
                ...
                keywords: M,
                contains: [{ scope: 'title.class.inherited', match: w }, ...A],
                relevance: 0,
              },
            ],
          };
    ...
    5745: function (e) {
      ...
      e.exports = function (e) {
        ...
        Object.assign(i.keywords, u), i.exports.PARAMS_CONTAINS.push(b);
        const p = i.contains.find((e) => 'attr' === e.className);
        return (
          i.exports.PARAMS_CONTAINS.push([i.exports.CLASS_REFERENCE, p]),
          (i.contains = i.contains.concat([b, d, g])),
          m(i, 'shebang', e.SHEBANG()),
          m(i, 'use_strict', { className: 'meta', relevance: 10, begin: /^\s*['"]use strict['"]/ }),
