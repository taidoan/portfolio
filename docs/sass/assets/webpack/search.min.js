  ...
  [187],
  {
    4429: function (e, t, r) {
      ...
      var n = r(6478),
        ...
        l = r.n(c),
        f = r(6556);
      r(9594), r(19), l().installJinjaCompat();
      const h = l().Loader.extend({
          getSource: (e) => ({
            src: { type: 'code', obj: window.nunjucksPrecompiled[e] },
            path: e,
          }),
        }),
        p = new (l().Environment)(new h());
      let d;
      const v = (e) => {
          const t = { title: [], contents: [] };
          return (
            Object.keys(e).forEach((r) => {
              Object.keys(e[r]).forEach((n) => {
                const i = e[r][n].position.map((e) => ({ start: e[0], length: e[1] }));
                t[n] = t[n].concat(i);
              });
            }),
            t
        ...
        y = (e, t) => {
          if (t.title.length) {
            ...
            new (u())(r).markRanges(t.title);
          }
          if (t.contents.length) {
            const r = e.find('[data-result-field="contents"]').get(0);
            t.contents.sort((e, t) => e.start - t.start),
              new (u())(r).markRanges(t.contents.slice(0, 5), {
                done: () => {
                  r.childNodes.forEach((e) => {
                    const t = null !== e.previousSibling,
                    ...
                    if ('#text' === e.nodeName) {
                      ...
                      t && r
                        ...
                        : r
                          ...
                          : t && n.length > 15 && n.splice(15, n.length - 15, '…'),
                        (e.nodeValue = n.join(' '));
                    }
                  });
                },
          ...
          e &&
            ...
            ((e, t) => {
              ...
              if (e && e.length)
                for (const t of e) {
                  const e = d[t.ref],
                    n = v(t.matchData.metadata);
                  if (n.title.length || n.contents.length) {
                    const i = {
                        url: t.ref,
                        title: e.title,
                        contents: n.contents.length ? e.contents : '',
                      },
                      o = f(p.render('search_result.njk', i));
                    y(o, n), (r = r.add(o));
                  }
                }
              const n = f(p.render('search_results.njk', { term: t, count: r.length }));
              n.filter('.js-search-results').html(r), f('[data-page]').html(n);
            })(s().Index.load(e.idx).search(t), t));
        };
      window.getSearchData = () => {
        const e = i()(window.location.search.substring(1));
        if (e && e.q) {
    ...
    9594: function () {
      (window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})['search_result.njk'] = {
        root: function (e, t, r, n, i) {
          var o = '';
          try {
            (o += '<li class="search-result text-block">\n  <h2><a href="'),
              (o += n.suppressValue(n.contextOrFrameLookup(t, r, 'url'), e.opts.autoescape)),
              (o += '" data-result-field="title">'),
              (o += n.suppressValue(n.contextOrFrameLookup(t, r, 'title'), e.opts.autoescape)),
              (o += '</a></h2>\n  <div data-result-field="contents">'),
              (o += n.suppressValue(n.contextOrFrameLookup(t, r, 'contents'), e.opts.autoescape)),
              i(null, (o += '</div>\n</li>\n'));
          } catch (e) {
            i(n.handleError(e, 0, 0));
          }
        },
      };
    },
    19: function () {
      (window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})['search_results.njk'] = {
        root: function (e, t, r, n, i) {
          var o = '';
          try {
            (o += '<h1 class="search-heading">\n  <span class="search-term">'),
              (o += n.suppressValue(n.contextOrFrameLookup(t, r, 'term'), e.opts.autoescape)),
              (o += '</span>:\n  '),
              (o += n.suppressValue(
              ...
              (o += ' '),
              (o += n.suppressValue(
                1 == n.contextOrFrameLookup(t, r, 'count') ? 'result' : 'results',
                e.opts.autoescape,
              )),
              (o += '\n</h1>\n\n'),
    ...
    6478: function (e, t, r) {
      !(function () {
        ...
        e.exports =
              ...
              ? (e
                  ...
                  .forEach(function (e) {
                    ...
                    if (
                      (/\[/.test(c[0]) && /\]$/.test(c[l])
                        ? ((c[l] = c[l].replace(/\]$/, '')),
                          (l = (c = c.shift().split('[').concat(c)).length - 1))
                        : (l = 0),
                      2 === o.length)
                    )
                      if (
                        ...
                        for (; u <= l; u++)
                          a = a[(s = '' === c[u] ? a.length : c[u])] =
                            u < l ? a[s] || (c[u + 1] && isNaN(c[u + 1]) ? {} : []) : i;
                      else
                        '[object Array]' === Object.prototype.toString.call(r[s])
                          ? r[s].push(i)
          ...
          (n = t) && (n.prototype.deparam = n.deparam = i),
          i);
      })();
    },
    1998: function (e, t, r) {
      ...
      !(function () {
        var o,
          ...
          F = function (e) {
            var t = new F.Builder();
            return (
              t.pipeline.add(F.trimmer, F.stopWordFilter, F.stemmer),
              t.searchPipeline.add(F.stemmer),
              e.call(t, t),
              t.build()
            );
          };
        (F.version = '2.3.9'),
          ...
          (F.FieldRef.joiner = '/'),
          (F.FieldRef.fromString = function (e) {
            var t = e.indexOf(F.FieldRef.joiner);
            if (-1 === t) throw 'malformed field ref string';
            var r = e.slice(0, t),
              n = e.slice(t + 1);
            return new F.FieldRef(n, r, e);
          }),
          (F.FieldRef.prototype.toString = function () {
            return (
              null == this._stringValue &&
                (this._stringValue = this.fieldName + F.FieldRef.joiner + this.docRef),
              this._stringValue
            );
          }),
          (F.Set = function (e) {
          ...
          (F.Set.prototype.intersect = function (e) {
            ...
            for (var o = 0; o < n.length; o++) {
              var s = n[o];
              s in r.elements && i.push(s);
            }
            return new F.Set(i);
          }),
          (F.Set.prototype.union = function (e) {
            return e === F.Set.complete
              ? F.Set.complete
              : e === F.Set.empty
                ? this
                : new F.Set(Object.keys(this.elements).concat(Object.keys(e.elements)));
          }),
          (F.idf = function (e, t) {
            var r = 0;
          ...
          (F.tokenizer = function (e, t) {
            ...
            for (
              var r = e.toString().toLowerCase(), n = r.length, i = [], o = 0, s = 0;
              o <= n;
              o++
            ) {
              var a = o - s;
              if (r.charAt(o).match(F.tokenizer.separator) || o == n) {
                if (a > 0) {
                  var u = F.utils.clone(t) || {};
                  (u.position = [s, a]),
                    (u.index = i.length),
                    i.push(new F.Token(r.slice(s, o), u));
                }
                s = o + 1;
              }
            }
          ...
          (F.tokenizer.separator = /[\s\-]+/),
          (F.Pipeline = function () {
            this._stack = [];
          }),
          (F.Pipeline.registeredFunctions = Object.create(null)),
          (F.Pipeline.registerFunction = function (e, t) {
            t in this.registeredFunctions &&
              F.utils.warn('Overwriting existing registered function: ' + t),
              (e.label = t),
              (F.Pipeline.registeredFunctions[e.label] = e);
          }),
          ...
          (F.Pipeline.prototype.run = function (e) {
            for (var t = this._stack.length, r = 0; r < t; r++) {
              for (var n = this._stack[r], i = [], o = 0; o < e.length; o++) {
                var s = n(e[o], o, e);
                if (null != s && '' !== s)
                  if (Array.isArray(s)) for (var a = 0; a < s.length; a++) i.push(s[a]);
                  else i.push(s);
              }
              e = i;
            }
          ...
          (F.stemmer =
            ...
            (Q = function (e) {
              ...
              if (
                ...
                var l = i.exec(e);
                (i = d).test(l[1]) && ((i = k), (e = e.replace(i, '')));
              } else
                o.test(e) &&
                  ((t = (l = o.exec(e))[1]),
                  (o = g).test(t) &&
                    ...
                    (o = E).test((e = t))
                      ...
                      : u.test(e)
                        ...
                        : c.test(e) && (e += 'e')));
              return (
                (i = L).test(e) && (e = (t = (l = i.exec(e))[1]) + 'i'),
                (i = T).test(e) &&
                  ((t = (l = i.exec(e))[1]), (r = l[2]), (i = d).test(t) && (e = t + s[r])),
                (i = j).test(e) &&
                  ((t = (l = i.exec(e))[1]), (r = l[2]), (i = d).test(t) && (e = t + a[r])),
                (o = I),
                (i = P).test(e)
                  ? ((t = (l = i.exec(e))[1]), (i = v).test(t) && (e = t))
                  : o.test(e) && ((t = (l = o.exec(e))[1] + l[2]), (o = v).test(t) && (e = t)),
                (i = R).test(e) &&
                  ((t = (l = i.exec(e))[1]),
                  (o = y),
                  (u = N),
                  ((i = v).test(t) || (o.test(t) && !u.test(t))) && (e = t)),
                (o = v),
                (i = _).test(e) && o.test(e) && ((i = k), (e = e.replace(i, ''))),
          ...
          F.Pipeline.registerFunction(F.stemmer, 'stemmer'),
          (F.generateStopWordFilter = function (e) {
          ...
          (F.stopWordFilter = F.generateStopWordFilter([
            'a',
            'able',
            'about',
            'across',
          ...
          F.Pipeline.registerFunction(F.stopWordFilter, 'stopWordFilter'),
          (F.trimmer = function (e) {
            return e.update(function (e) {
              return e.replace(/^\W+/, '').replace(/\W+$/, '');
            });
          }),
          F.Pipeline.registerFunction(F.trimmer, 'trimmer'),
          (F.TokenSet = function () {
            (this.final = !1),
              (this.edges = {}),
              (this.id = F.TokenSet._nextId),
              (F.TokenSet._nextId += 1);
          }),
          (F.TokenSet._nextId = 1),
          (F.TokenSet.fromArray = function (e) {
            for (var t = new F.TokenSet.Builder(), r = 0, n = e.length; r < n; r++) t.insert(e[r]);
            return t.finish(), t.root;
          }),
          (F.TokenSet.fromClause = function (e) {
            return 'editDistance' in e
              ? F.TokenSet.fromFuzzyString(e.term, e.editDistance)
              : F.TokenSet.fromString(e.term);
          }),
          (F.TokenSet.fromFuzzyString = function (e, t) {
            for (
              var r = new F.TokenSet(), n = [{ node: r, editsRemaining: t, str: e }];
              n.length;
              ...
              if (i.str.length > 0) {
                ...
                s in i.node.edges
                  ? (o = i.node.edges[s])
                  : ((o = new F.TokenSet()), (i.node.edges[s] = o)),
              ...
              if (0 != i.editsRemaining) {
                ...
                else (a = new F.TokenSet()), (i.node.edges['*'] = a);
                if (
                ...
                if (i.str.length > 1) {
                  ...
                  f in i.node.edges
                    ? (c = i.node.edges[f])
                    : ((c = new F.TokenSet()), (i.node.edges[f] = c)),
          ...
          (F.TokenSet.fromString = function (e) {
            for (var t = new F.TokenSet(), r = t, n = 0, i = e.length; n < i; n++) {
              var o = e[n],
                s = n == i - 1;
          ...
          (F.TokenSet.prototype.intersect = function (e) {
            for (
              var t = new F.TokenSet(), r = void 0, n = [{ qNode: e, output: t, node: this }];
              n.length;
              ...
              for (
                ...
                for (var c = i[u], l = 0; l < a; l++) {
                  var f = s[l];
                  if (f == c || '*' == c) {
                    var h = r.node.edges[f],
                      p = r.qNode.edges[c],
                      d = h.final && p.final,
                      v = void 0;
                    f in r.output.edges
                      ? ((v = r.output.edges[f]).final = v.final || d)
                      : (((v = new F.TokenSet()).final = d), (r.output.edges[f] = v)),
          ...
          (F.TokenSet.Builder.prototype.insert = function (e) {
            ...
            for (
              ...
              var i = new F.TokenSet(),
                o = e[n];
              (t.edges[o] = i), this.uncheckedNodes.push({ parent: t, char: o, child: i }), (t = i);
            }
          ...
          (F.Index.prototype.query = function (e) {
            ...
            for (e.call(t, t), a = 0; a < t.clauses.length; a++) {
              ...
              for (var f = 0; f < u.length; f++) {
                var h = u[f];
                c.term = h;
                var p = F.TokenSet.fromClause(c),
                  d = this.tokenSet.intersect(p).toArray();
                if (0 === d.length && c.presence === F.Query.presence.REQUIRED) {
                  for (var v = 0; v < c.fields.length; v++) o[(R = c.fields[v])] = F.Set.empty;
                  break;
                }
                for (var y = 0; y < d.length; y++) {
                  var g = d[y],
                    m = this.invertedIndex[g],
                    x = m._index;
                  for (v = 0; v < c.fields.length; v++) {
                    var w = m[(R = c.fields[v])],
                      b = Object.keys(w),
                      k = g + '/' + R,
                      E = new F.Set(b);
                    if (
                      (c.presence == F.Query.presence.REQUIRED &&
                        ((l = l.union(E)), void 0 === o[R] && (o[R] = F.Set.complete)),
                      c.presence != F.Query.presence.PROHIBITED)
                    ) {
                      if (
                        (n[R].upsert(x, c.boost, function (e, t) {
                          return e + t;
                        }),
                        !i[k])
                      ) {
                        for (var S = 0; S < b.length; S++) {
                          var O,
                            L = b[S],
                            T = new F.FieldRef(L, R),
                            j = w[L];
                          void 0 === (O = r[T])
                            ? (r[T] = new F.MatchData(g, R, j))
                            : O.add(g, R, j);
                        }
                        i[k] = !0;
                      }
                    } else void 0 === s[R] && (s[R] = F.Set.empty), (s[R] = s[R].union(E));
                  }
                }
              }
              if (c.presence === F.Query.presence.REQUIRED)
                for (v = 0; v < c.fields.length; v++) o[(R = c.fields[v])] = o[R].intersect(l);
            }
            var P = F.Set.complete,
              I = F.Set.empty;
            for (a = 0; a < this.fields.length; a++) {
              var R;
              o[(R = this.fields[a])] && (P = P.intersect(o[R])), s[R] && (I = I.union(s[R]));
            }
            var _ = Object.keys(r),
              N = [],
              Q = Object.create(null);
            if (t.isNegated())
              for (_ = Object.keys(this.fieldVectors), a = 0; a < _.length; a++) {
                T = _[a];
                var C = F.FieldRef.fromString(T);
                r[T] = new F.MatchData();
              }
            for (a = 0; a < _.length; a++) {
              var A = (C = F.FieldRef.fromString(_[a])).docRef;
              if (P.contains(A) && !I.contains(A)) {
                var M,
                  D = this.fieldVectors[C],
                  B = n[C.fieldName].similarity(D);
                if (void 0 !== (M = Q[A])) (M.score += B), M.matchData.combine(r[C]);
                else {
                  var V = { ref: A, score: B, matchData: r[C] };
                  (Q[A] = V), N.push(V);
                }
              }
            }
          ...
          (F.Builder = function () {
            (this._ref = 'id'),
              ...
              (this.fieldLengths = {}),
              (this.tokenizer = F.tokenizer),
              (this.pipeline = new F.Pipeline()),
              (this.searchPipeline = new F.Pipeline()),
          ...
          (F.Builder.prototype.add = function (e, t) {
            ...
            for (var i = 0; i < n.length; i++) {
              var o = n[i],
                ...
                a = s ? s(e) : e[o],
                u = this.tokenizer(a, { fields: [o] }),
                c = this.pipeline.run(u),
                l = new F.FieldRef(r, o),
              ...
              for (var h = 0; h < c.length; h++) {
                var p = c[h];
                if ((null == f[p] && (f[p] = 0), (f[p] += 1), null == this.invertedIndex[p])) {
                  var d = Object.create(null);
                  (d._index = this.termIndex), (this.termIndex += 1);
                  for (var v = 0; v < n.length; v++) d[n[v]] = Object.create(null);
                  this.invertedIndex[p] = d;
                }
                null == this.invertedIndex[p][o][r] &&
                  (this.invertedIndex[p][o][r] = Object.create(null));
                for (var y = 0; y < this.metadataWhitelist.length; y++) {
                  var g = this.metadataWhitelist[y],
                    m = p.metadata[g];
                  null == this.invertedIndex[p][o][r][g] && (this.invertedIndex[p][o][r][g] = []),
                    this.invertedIndex[p][o][r][g].push(m);
                }
              }
            }
          }),
          (F.Builder.prototype.calculateAverageFieldLengths = function () {
            for (
              ...
              var o = F.FieldRef.fromString(e[i]),
                s = o.fieldName;
              n[s] || (n[s] = 0), (n[s] += 1), r[s] || (r[s] = 0), (r[s] += this.fieldLengths[o]);
            }
          ...
          (F.Builder.prototype.createFieldVectors = function () {
            for (
              ...
              for (
                var o = F.FieldRef.fromString(t[i]),
                  s = o.fieldName,
                ...
                var v,
                  ...
                  m = l[d],
                  x = c[m],
                  w = this.invertedIndex[m]._index;
                void 0 === n[m]
                  ? ((v = F.idf(this.invertedIndex[m], this.documentCount)), (n[m] = v))
                  : (v = n[m]),
                  (y =
                    (v * ((this._k1 + 1) * x)) /
                    (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[s])) + x)),
                  (y *= h),
                  (y *= p),
                  (g = Math.round(1e3 * y) / 1e3),
                  u.insert(w, g);
              }
              e[o] = u;
            }
          ...
          (F.MatchData = function (e, t, r) {
            for (var n = Object.create(null), i = Object.keys(r || {}), o = 0; o < i.length; o++) {
              var s = i[o];
              n[s] = r[s].slice();
            }
          ...
          (F.MatchData.prototype.combine = function (e) {
            for (var t = Object.keys(e.metadata), r = 0; r < t.length; r++) {
              ...
              for (var o = 0; o < i.length; o++) {
                var s = i[o],
                  a = Object.keys(e.metadata[n][s]);
                null == this.metadata[n][s] && (this.metadata[n][s] = Object.create(null));
                for (var u = 0; u < a.length; u++) {
                  var c = a[u];
                  null == this.metadata[n][s][c]
                    ? (this.metadata[n][s][c] = e.metadata[n][s][c])
                    : (this.metadata[n][s][c] = this.metadata[n][s][c].concat(e.metadata[n][s][c]));
                }
              }
            }
          }),
          ...
          (F.Query.wildcard = new String('*')),
          (F.Query.wildcard.NONE = 0),
          (F.Query.wildcard.LEADING = 1),
          (F.Query.wildcard.TRAILING = 2),
          (F.Query.presence = { OPTIONAL: 1, REQUIRED: 2, PROHIBITED: 3 }),
          (F.Query.prototype.clause = function (e) {
            return (
              ...
              'wildcard' in e || (e.wildcard = F.Query.wildcard.NONE),
              e.wildcard & F.Query.wildcard.LEADING &&
                e.term.charAt(0) != F.Query.wildcard &&
                (e.term = '*' + e.term),
              e.wildcard & F.Query.wildcard.TRAILING &&
                e.term.slice(-1) != F.Query.wildcard &&
                (e.term = e.term + '*'),
              'presence' in e || (e.presence = F.Query.presence.OPTIONAL),
              this.clauses.push(e),
              this
            );
          }),
          ...
          (F.QueryParseError.prototype = new Error()),
          (F.QueryLexer = function (e) {
            (this.lexemes = []),
              (this.str = e),
              (this.length = e.length),
              (this.pos = 0),
          ...
          (F.QueryLexer.EOS = 'EOS'),
          (F.QueryLexer.FIELD = 'FIELD'),
          (F.QueryLexer.TERM = 'TERM'),
          (F.QueryLexer.EDIT_DISTANCE = 'EDIT_DISTANCE'),
          (F.QueryLexer.BOOST = 'BOOST'),
          (F.QueryLexer.PRESENCE = 'PRESENCE'),
          (F.QueryLexer.lexField = function (e) {
            return e.backup(), e.emit(F.QueryLexer.FIELD), e.ignore(), F.QueryLexer.lexText;
          }),
          (F.QueryLexer.lexTerm = function (e) {
            if ((e.width() > 1 && (e.backup(), e.emit(F.QueryLexer.TERM)), e.ignore(), e.more()))
              return F.QueryLexer.lexText;
          }),
          (F.QueryLexer.lexEditDistance = function (e) {
            return (
              e.ignore(),
              e.acceptDigitRun(),
              e.emit(F.QueryLexer.EDIT_DISTANCE),
              F.QueryLexer.lexText
            );
          }),
          ...
          (F.QueryLexer.termSeparator = F.tokenizer.separator),
          (F.QueryLexer.lexText = function (e) {
            for (;;) {
              var t = e.next();
              ...
              if (92 != t.charCodeAt(0)) {
                ...
                if ('~' == t)
                  return (
                    e.backup(),
                    e.width() > 0 && e.emit(F.QueryLexer.TERM),
                    F.QueryLexer.lexEditDistance
                  );
                if ('^' == t)
                  return (
                    e.backup(), e.width() > 0 && e.emit(F.QueryLexer.TERM), F.QueryLexer.lexBoost
                  );
                if ('+' == t && 1 === e.width())
              ...
              switch (t.type) {
                ...
                default:
                  ...
                  throw (
                    ...
                    new F.QueryParseError(r, t.start, t.end))
                  );
              }
          }),
              ...
              switch (n.type) {
                ...
                default:
                  throw (
                    ...
                    new F.QueryParseError(r, n.start, n.end))
                  );
              }
            }
          }),
          (F.QueryParser.parseField = function (e) {
            ...
            if (null != t) {
              ...
              if (null == i)
                throw (
                  ((n = 'expecting term, found nothing'), new F.QueryParseError(n, t.start, t.end))
                );
              if (i.type === F.QueryLexer.TERM) return F.QueryParser.parseTerm;
              throw (
                ((n = "expecting term, found '" + i.type + "'"),
                new F.QueryParseError(n, i.start, i.end))
              );
            }
          }),
                      ...
                      var n = this,
                        ...
                        s = function s() {
                          if (!i) {
                            ...
                            try {
                              n.isIframeBlank(e) ||
                                (e.removeEventListener('load', s), n.getIframeContents(e, t, r));
                            } catch (e) {
                              r();
                            }
                          }
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      this.forEachIframe(
                        ...
                        function (e) {
                          n++,
                            r.waitForIframes(e.querySelector('html'), function () {
                              --n || t();
                            });
                        },
                        function (e) {
                    ...
                    value: function (e, t, r, n, i) {
                      for (
                        var o = this,
                          ...
                          c = void 0,
                          l = void 0;
                        (f = void 0), (f = o.getIteratorNode(s)), (l = f.prevNode), (c = f.node);
              ...
              r(o, [
                {
                  ...
                  value: function (t) {
                    var r =
                        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'debug',
                      n = this.opt.log;
                    this.opt.debug &&
                    ...
                    for (var i in t)
                      if (t.hasOwnProperty(i)) {
                        ...
                        '' !== s &&
                          ...
                          (e = e.replace(
                            new RegExp(
                              '(' + this.escapeStr(s) + '|' + this.escapeStr(a) + ')',
                              'gm' + r,
                            ),
                            n +
                              '(' +
                      ...
                      e.split('').forEach(function (i) {
                        r.every(function (r) {
                          if (-1 !== r.indexOf(i)) {
                            ...
                            (e = e.replace(new RegExp('[' + r + ']', 'gm' + t), '[' + r + ']')),
                              n.push(r);
                          }
                          return !0;
                        });
                      ...
                      e
                        ...
                        .forEach(function (e) {
                          var i = t.callNoMatchOnInvalidRanges(e, n),
                            o = i.start,
                            s = i.end;
                          i.valid && ((e.start = o), (e.length = s - o), r.push(e), (n = s));
                        }),
                      r
                    );
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    return (
                      e && void 0 !== e.start
                        ? ((n = (r = parseInt(e.start, 10)) + parseInt(e.length, 10)),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this.iterator.forEachNode(
                      ...
                      function (e) {
                        n.push({ start: r.length, end: (r += e.textContent).length, node: e });
                      },
                      function (e) {
                  ...
                  value: function (e, t, r, n, i) {
                    ...
                    e.nodes.every(function (s, a) {
                      ...
                      if (void 0 === u || u.start > t) {
                        ...
                        var c = t - s.start,
                          l = (r > s.end ? s.end : r) - s.start,
                          f = e.value.substr(0, s.start),
                          h = e.value.substr(l + s.start);
                        if (
                          ((s.node = o.wrapRangeInTextNode(s.node, c, l)),
                          (e.value = f + h),
                          e.nodes.forEach(function (t, r) {
                            r >= a &&
                              (e.nodes[r].start > 0 && r !== a && (e.nodes[r].start -= l),
                              (e.nodes[r].end -= l));
                          }),
                          (r -= l),
                    ...
                    this.getTextNodes(function (t) {
                      t.nodes.forEach(function (t) {
                        ...
                        for (var i = void 0; null !== (i = e.exec(t.textContent)) && '' !== i[s]; )
                          if (r(i[s], t)) {
                            var a = i.index;
                            if (0 !== s) for (var u = 1; u < s; u++) a += i[u].length;
                  ...
                  value: function (e, t) {
                    ...
                    this.opt.acrossElements && (i = 'wrapMatchesAcrossElements'),
                      0 === a
                        ? this.opt.done(n)
                        : (function e(t) {
                            var o = new RegExp(r.createRegExp(t), 'gm' + u),
                              c = 0;
                            r.log('Searching with expression "' + o + '"'),
                              r[i](
                                ...
                                function () {
                                  0 === c && r.opt.noMatch(t),
                                    s[a - 1] === t ? r.opt.done(n) : e(s[s.indexOf(t) + 1]);
                                },
                              );
                          })(s[0]);
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    i && i.length
                      ? (this.log(
                          'Starting to mark with the following ranges: ' + JSON.stringify(i),
                        ),
        ...
        (t = function () {
          return (function (e) {
            ...
            function (e, t, r) {
              ...
              function c(e, t, r) {
                ...
                if (
                  ...
                  Object.setPrototypeOf
                    ? ((n = new Error(e)), Object.setPrototypeOf(n, c.prototype))
                    : ((n = this),
                  ...
                  Object.defineProperty(n, 'name', { value: 'Template render error' }),
                  Error.captureStackTrace && Error.captureStackTrace(n, this.constructor),
                  i)
                ) {
                  var s = Object.getOwnPropertyDescriptor(i, 'stack');
                  (o =
                    s &&
                    (s.get ||
                      function () {
              ...
              function d(e) {
                var t,
                  r = (t = e) ? ('string' == typeof t ? t.split('.') : [t]) : [];
                return function (e) {
              ...
              ((t = e.exports = {}).hasOwnProp = a),
                ...
                (t.groupBy = function (e, t, r) {
                  for (var n = {}, i = l(t) ? t : d(t), o = 0; o < e.length; o++) {
                    var s = e[o],
                      a = i(s, o);
                    if (void 0 === a && !0 === r)
                ...
                (t.without = function (e) {
                  var t = [];
                  if (!e) return t;
                  for (var r = e.length, n = v(arguments).slice(1), i = -1; ++i < r; )
                    -1 === y(n, e[i]) && t.push(e[i]);
                  return t;
                }),
                ...
                (t.each = function (e, t, r) {
                  if (null != e)
                    if (n.forEach && e.forEach === n.forEach) e.forEach(t, r);
                      ...
                      for (var i = 0, o = e.length; i < o; i++) t.call(r, e[i], i, e);
                }),
                (t.map = function (e, t) {
                  var r = [];
                  if (null == e) return r;
                ...
                (t.inOperator = function (e, t) {
                  if (f(t) || h(t)) return -1 !== t.indexOf(e);
            ...
            function (e, t, r) {
              ...
              var n = r(1),
                i = Array.from,
                o = 'function' == typeof Symbol && Symbol.iterator && 'function' == typeof i,
                s = (function () {
                  function e(e, t) {
                ...
                (e.exports = {
                  ...
                  makeMacro: function (e, t, r) {
                    return function () {
                      ...
                      if (c > e.length)
                        (s = i.slice(0, e.length)),
                          i.slice(s.length, c).forEach(function (e, r) {
                            r < t.length && (l[t[r]] = e);
                          }),
                          s.push(l);
                      else if (c < e.length) {
                  ...
                  asyncAll: function (e, t, r, i) {
                    ...
                    if (n.isArray(e))
                      if (((o = e.length), (s = new Array(o)), 0 === o)) i(null, '');
                      else
                        for (var c = 0; c < e.length; c++) {
                          ...
                          switch (t) {
                            ...
                            case 3:
                              ...
                              break;
                            default:
                              l.push(c, o, u), r.apply(this, l);
                          }
                        }
                    else {
                      var f = n.keys(e || {});
                      if (((o = f.length), (s = new Array(o)), 0 === o)) i(null, '');
                      else
            ...
            function (e, t, r) {
              ...
              function g(e, t) {
                ...
                return (
                  ...
                  c.FileSystemLoader
                    ? (r = new c.FileSystemLoader(e, { watch: t.watch, noCache: t.noCache }))
                    : c.WebLoader &&
                      (r = new c.WebLoader(e, {
              ...
              e.exports = {
                ...
                compile: function (e, t, r, i) {
                  return n || g(), new a(e, t, r, i);
                },
                render: function (e, t, r) {
                  return n || g(), n.render(e, t, r);
                },
                renderString: function (e, t, r) {
                  return n || g(), n.renderString(e, t, r);
                },
            ...
            function (e, t, r) {
              ...
              var o = r(8),
                ...
                c = r(12),
                l = r(3),
                f = l.FileSystemLoader,
                h = l.WebLoader,
                p = l.PrecompiledLoader,
                d = r(14),
                v = r(15),
                y = r(5),
                g = y.Obj,
                ...
                O = (function (e) {
                  ...
                  return (
                    (r.init = function (e, t) {
                      ...
                      (t = this.opts = t || {}),
                        ...
                        e
                          ...
                          : f
                            ? (this.loaders = [new f('views')])
                            : h && (this.loaders = [new h('/views')]),
                        'undefined' != typeof window &&
                          window.nunjucksPrecompiled &&
                          this.loaders.unshift(new p(window.nunjucksPrecompiled)),
                        this._initLoaders(),
                        (this.globals = v()),
                        (this.filters = {}),
                        (this.tests = {}),
                        ...
                        (this.extensions = {}),
                        (this.extensionsList = []),
                        a._entries(c).forEach(function (e) {
                          var t = e[0],
                            n = e[1];
                    ...
                    (r.addExtension = function (e, t) {
                      return (
                        (t.__name = e), (this.extensions[e] = t), this.extensionsList.push(t), this
                      );
                    }),
                    (r.removeExtension = function (e) {
                      var t = this.getExtension(e);
                      t &&
                        ((this.extensionsList = a.without(this.extensionsList, t)),
                    ...
                    (r.getTemplate = function (e, t, r, n, i) {
                      ...
                      if (
                        (e && e.raw && (e = e.raw),
                        a.isFunction(r) && ((i = r), (r = null), (t = t || !1)),
                        a.isFunction(t) && ((i = t), (t = !1)),
                        e instanceof T)
                      )
                        c = e;
                      else {
                        ...
                        for (var l = 0; l < this.loaders.length; l++) {
                          var f = this.loaders[l];
                          if ((c = f.cache[this.resolveTemplate(f, r, e)])) break;
                        }
                      }
                      return c
                        ...
                        : (a.asyncIter(
                            ...
                            function (r, a) {
                              ...
                              var u;
                              a
                                ? ((u = new T(a.src, s, a.path, t)),
                                  a.noCache || (a.loader.cache[e] = u))
                                : (u = new T(S, s, '', t)),
                                i ? i(null, u) : (o = u);
                            },
                          ),
                    ...
                    (r.renderString = function (e, t, r, n) {
                      return (
                        a.isFunction(r) && ((n = r), (r = {})),
                        new T(e, this, (r = r || {}).path).render(t, n)
                      );
                    }),
                  ...
                  return (
                    ...
                    (r.render = function (e, t, r) {
                      ...
                      try {
                        ...
                        var o = a._prettifyError(this.path, this.env.opts.dev, e);
                        if (r) return E(r, o);
                        throw o;
                      }
                      ...
                      var c = null,
                        l = !1;
                      return (
                        this.rootRenderFunc(this.env, s, u, x, function (e, t) {
                          if (!l || !r || void 0 === t)
                            if (
                              (e && ((e = a._prettifyError(n.path, n.env.opts.dev, e)), (l = !0)),
                              r)
                            )
                              i ? E(r, e, t) : r(e, t);
                            else {
                    ...
                    (r.getExported = function (e, t, r) {
                      ...
                      var n = t ? t.push() : new b();
                      n.topLevel = !0;
                      var i = new L(e || {}, this.blocks, this.env);
                      this.rootRenderFunc(this.env, i, n, x, function (e) {
                ...
                function s() {
                  for (; o < i.length; ) {
                    ...
                    if (((o += 1), i[e].call(), o > 1024)) {
                      for (var t = 0, r = i.length - o; t < r; t++) i[t] = i[t + o];
                      (i.length -= o), (o = 0);
                    }
                  }
                  (i.length = 0), (o = 0);
            ...
            function (e, t, r) {
              ...
              ((t = e.exports = {}).abs = Math.abs),
                ...
                (t.escape = function (e) {
                  return e instanceof i.SafeString
                    ? e
                    : ((e = null == e ? '' : e), i.markSafe(n.escape(e.toString())));
                }),
                (t.safe = function (e) {
                  return e instanceof i.SafeString
                    ? e
                ...
                (t.forceescape = function (e) {
                  return (e = null == e ? '' : e), i.markSafe(n.escape(e.toString()));
                }),
                ...
                (t.nl2br = function (e) {
                  return null == e ? '' : i.copySafeness(e, e.replace(/\r\n|\n/g, '<br />\n'));
                }),
                (t.random = function (e) {
                ...
                (t.replace = function (e, t, r, n) {
                  ...
                  if (
                    ...
                    return e;
                  if ('' === t) return (s = r + e.split('').join(r) + r), i.copySafeness(e, s);
                  var a = e.indexOf(t);
                  if (0 === n || -1 === a) return e;
                  for (var u = 0, c = 0; a > -1 && (-1 === n || c < n); )
                    (s += e.substring(u, a) + r), (u = a + t.length), c++, (a = e.indexOf(t, u));
                  return u < e.length && (s += e.substring(u)), i.copySafeness(o, s);
                }),
                ...
                (t.round = function (e, t, r) {
                  ...
                  var n = Math.pow(10, t);
                  return (
                    ('ceil' === r ? Math.ceil : 'floor' === r ? Math.floor : Math.round)(e * n) / n
                  );
                }),
                (t.slice = function (e, t, r) {
                  for (
                    var n = Math.floor(e.length / t), i = e.length % t, o = [], s = 0, a = 0;
                    a < t;
                    a++
                  ) {
                    var u = s + a * n;
                  ...
                  function (e, t, r, i) {
                    ...
                    return (
                      s.sort(function (e, s) {
                        var u = i ? a(e) : e,
                          c = i ? a(s) : s;
                        if (o.env.opts.throwOnUndefined && i && (void 0 === u || void 0 === c))
                          throw new TypeError('sort: attribute "' + i + '" resolved to undefined');
                        return (
                          !r &&
                            n.isString(u) &&
                            n.isString(c) &&
                            ((u = u.toLowerCase()), (c = c.toLowerCase())),
                          u < c ? (t ? 1 : -1) : u > c ? (t ? -1 : 1) : 0
                        );
                      }),
                      s
                    );
                ...
                (t.striptags = function (e, t) {
                  var r,
                    n = l(
                      (e = o(e, '')).replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>|<!--[\s\S]*?-->/gi, ''),
                    );
                  return (
                    (r = t
                      ? n
                ...
                (t.truncate = function (e, t, r, n) {
                  ...
                  return (e += null != n ? n : '...'), i.copySafeness(s, e);
                }),
                (t.upper = function (e) {
              ...
              var y = i.makeMacro(['value', 'default', 'base'], [], function (e, t, r) {
                void 0 === r && (r = 10);
                var n = parseInt(e, r);
                return s(n) ? t : n;
              });
              (t.int = y), (t.d = t.default), (t.e = t.escape);
            },
            function (e, t, r) {
              'use strict';
              var n,
              ...
              e.exports = function () {
                ...
                function u(e, t, n, i) {
                  (e = e || []),
                    ...
                    null === n ? (n = i < 0 ? -1 : e.length) : n < 0 && (n += e.length),
                    t < 0 && (t += e.length);
                  for (
                    var o = [], s = t;
                    !(s < 0 || s > e.length || (i > 0 && s >= n) || (i < 0 && s <= n));
                    s += i
                  )
                    o.push(r.memberLookup(e, s));
                  return o;
                }
                function c(e, t) {
                  return Object.prototype.hasOwnProperty.call(e, t);
