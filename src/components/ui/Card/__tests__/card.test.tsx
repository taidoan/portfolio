...
describe('<CardTitle>', () => {
  ...
  it('renders a card title wrapped in a link if the link is provided', async () => {
    await act(async () => {
      render(
        <Card data={mockProjectData} href='/example' target='_blank' title='Example Link'>
          <CardTitle />
        </Card>,
      );
    });
...
describe('<CardImage>', () => {
  it('renders a card image component', () => {
    ...
    render(
      <Card>
        <CardImage src={mockProjectData.thumbnail?.filename || null} alt='Example Image' />
      </Card>,
    );
  ...
  it('renders an overlay if the relation is projects', async () => {
    await act(async () => {
      render(
        <Card relation='projects' data={mockProjectData}>
